...
<div className=' mx-5 my-3' style={{display:"flex",justifyContent:"center"}}>
    <button type="button"  className='btn btn-dark'><a href="rideit_frontend/x.html" style={{textDecoration:'none',color:"white",display:"flex",justifyContent:"center"}} >Book a Cab</a></button>
</div>
</div>
