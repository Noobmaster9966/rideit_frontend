    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item p-2"style={{fontFamily:"Baloo Bhai 2",fontWeight:'bold'}}>
          <a className="nav-link active" aria-current="page" href="/rideit_frontend">Book a Ride</a>
        </li>
        <li className="nav-item p-2" style={{fontFamily:"Baloo Bhai 2",fontWeight:'bold'}} >
          <a className="nav-link" href="/rideit_frontend">RIDEIT PRO</a>
        </li>
        <li className="nav-item p-2"style={{fontFamily:"Baloo Bhai 2",fontWeight:'bold'}}>
          <a className="nav-link" href="/rideit_frontend/aboutus">
            About Us
          </a>
